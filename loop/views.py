...
def dynamic_response(request):
    ...
    request_url = "http://ivrapi.indiantts.co.in/tts?type=indiantts&api_key=2beeac80-095d-11e7-9f56-2f87492859b0&user_id=8937&audioformat=wav&samplerate=8000&numeric=hdigit&channelType=mono&text="
