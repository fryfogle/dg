...
tableDictionary={
    ...
    'listVideoScreened':'activities_screeningwisedata',   #TODO: Not working
...
#    'numPeople':{'count(id)':True,'count(distinct id)':False},
    ...
    'numAnimator':{'count(animator_id)':'Number of Animator','count(distinct animator_id)':'Number of Unique Animators'},
